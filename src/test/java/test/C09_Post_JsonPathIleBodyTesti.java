...
public class C09_Post_JsonPathIleBodyTesti {
    ...
    public void post01(){
        ...
        innerBody.put("checkin","2021-06-01"); // once icleri yapiyoruz
        innerBody.put("checkout","2021-06-10");

        reqBody.put("firstname" , "Ali");// sonra dıs obje bilgilerini yerlestirecegiz
        ...
        // 4 - Assertion  // donen responsun testını bu sekilde yaparız
        response.
                then().
                assertThat().
                statusCode(200).
