...
public class C19_Put_TestDataClassKullanimi extends JsonPlaceHolderBaseURL {
    ...
    public void put01(){
        ...
        assertEquals(testDataJsonPlaceHolder.contentType,response.getStatusCode());
        assertEquals(testDataJsonPlaceHolder.connectionHeaderDegeri,response.getStatusCode());
